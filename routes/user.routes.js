...
const { getUsersValidator, changeRoleValidator, editInfoFromUsersideValidator, userBagValidator, banUserValidator } = require("../validators/user.validator");
...
router.put('/ban/:userId',authMiddleware,roleGardMiddleware([]), banUserValidator(), controller.banUser)
