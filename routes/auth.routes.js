...
const { sendOtpValidator, registerValidator, loginValidator, forgetPasswordValidator, verifyOtpValidator, resetPasswordValidator, getCaptchaValidator, resendOtpValidator } = require("../validators/auth.validator")
